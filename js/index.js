...
open.addEventListener('click', function () {
  ...
  // linkInfo.classList.remove('animated', 'fadeOutDown');
  ...
  // linkInfo.classList.add('animated', 'fadeInUp');
...
close.addEventListener('click', function () {
  ...
  // linkInfo.classList.remove('animated', 'fadeInUp');
  ...
  // linkInfo.classList.add('animated', 'fadeOutDown');
